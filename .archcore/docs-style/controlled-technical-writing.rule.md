...
- The post-write precision check in `@internal/advisory/precision.go` measures a document against the canon data in `@templates/precision.go`. The check reports and never blocks.
